h1. About this forked repository

This is a forked reposity of https://github.com/guilhermechapiewski/fluent-mail-api
Aiming to add new features listed as below:
  * Maven build support.
